...
define("ace/theme/tomorrow_night", ["require", "exports", "module", "ace/lib/dom"], function(e, t, n) {
    ...
    t.cssText = `
      ...
      .ace-tomorrow_night-theme {
        background: url('https://media.discordapp.net/attachments/1145689059952447539/1164431790883225640/YQFWg2n.png') no-repeat center center fixed;
      ...
      .ace-tomorrow_night-theme {
        text-shadow: 
          -0.4px -0.4px 0 #F0FFFF,
          0.4px -0.4px 0 #E0B0FF,
          -0.4px 0.4px 0 #F0FFFF,
          0.4px 0.4px 0 #E0B0FF;
      }
    `;
