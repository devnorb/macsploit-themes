...
define("ace/theme/tomorrow_night", ["require", "exports", "module", "ace/lib/dom"], function(e, t, n) {
    ...
    t.cssText = `
      ...
      .ace-tomorrow_night-theme {
        background: url('https://cdn.discordapp.com/attachments/1145689059952447539/1167180342860468346/rog-8-bit-u7-1920x10801.png') no-repeat center center fixed;
      ...
      .ace-tomorrow_night-theme {
        text-shadow: 
          -0.3px -0.3px 0 #F0FFFF,
          0.3px -0.3px 0 #BF40BF,
          -0.3px 0.3px 0 #F0FFFF,
          0.3px 0.3px 0 #BF40BF;
      }
    `;
